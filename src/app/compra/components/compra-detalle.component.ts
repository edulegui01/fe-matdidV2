...
@Component({
  ...
  templateUrl: '../templates/compra-detalle.component.html',
  styleUrls: ['../styles/compra-detalle.component.scss']
})
export class CompraDetalleComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  openPagoRegister(element:any){
    this.dialogInstance.open(PagoFormComponent, {
      width: Settings.DIALOG_MEDIUM,
      data: {
          typeDialog: 'confirm',
          title: this.viewText.ATTENTION,
