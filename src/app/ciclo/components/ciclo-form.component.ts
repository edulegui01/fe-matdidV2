...
@Component({
  ...
  templateUrl: '../templates/ciclo-form.component.html',
  styleUrls: ['../styles/ciclo-form.component.scss']
})
export class CicloFormComponent implements OnInit {
  ...
  constructor(public cicloService:CicloService, private formBuilder:FormBuilder, router: Router, private dialogInstance: MatDialog ) { 
    ...
    if (this.entityForm.invalid) {
      ...
      this.dialogInstance.open(CustomDialogComponent, {
          ...
          if (data) {
              ...
              this.cicloService.saveCiclo(this.localidad).subscribe(result => {
                this.routerInstance.navigate(['../ciclo/listar-ciclo'])
              });
          }
      });
  ...
  updateCiclo(){
    ...
    if (this.entityForm.invalid) {
      ...
      this.dialogInstance.open(CustomDialogComponent, {
          ...
          if (data) {
            this.cicloService.updateCiclo(this.entity.id,this.localidad).subscribe((result:any) => {
              this.routerInstance.navigate(['../ciclo/listar-ciclo'])
  ...
  closeForm() {
    this.routerInstance.navigate(['../ciclo/listar-ciclo']);
    this.cicloService.editForm = false;
  }
