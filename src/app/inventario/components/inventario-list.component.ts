...
@Component({
  ...
  templateUrl: '../templates/inventario-list.component.html',
  styleUrls: ['../styles/inventario-list.component.scss']
})
export class InventarioListComponent  implements OnInit {
  ...
  initDataSource(){
    this.inventarioService.getProducto().subscribe( (inventarioData:any) => this.dataSource = inventarioData)
  }
